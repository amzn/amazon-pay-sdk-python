> **Important:** This SDK has been deprecated and no longer maintained. No further updates or security patches will be
  provided. New integrations should refer this [documentation](https://developer.amazon.com/docs/amazon-pay/intro.html) for more details.
